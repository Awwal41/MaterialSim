...
def main():
    ...
    print("\n🎯 Features:")
    print("  • Voice agent — speak to run simulations")
    print("  • Intelligent LLM routing with online research")
    print("  • Real molecular dynamics (ASE engine)")
    print("  • Natural language chat interface")
    print("  • RDF / MSD / thermodynamics analysis")
